...
<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-creme dark:bg-gray-900">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
        <h1 class="text-4xl py-2 text-center text-gray-700 font-bold">Verify email</h1>
        ...
        <div class="mt-4 flex items-center justify-between">
            <x-primary-button wire:click="sendVerification" class="ms-4 bg-nikol-500 hover:bg-nikol-700">
